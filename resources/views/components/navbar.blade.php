<nav class="navbar navbar-expand-lg header5 container-fluid">
    <a class="ms-2" href="/">
      <img class="img-fluid" src="/storage/img/arrow.png" width="50" height="60" alt="">
    </a>
    <div class="col-11 mx-auto d-flex align-items-center justify-content-between order-1 w-50 me-2">
      <div class="searchBox">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex justify-content-center align-items-center w-100 col-12 col-md-10 order-1">
  ...
  {{-- <div class="container-fluid py-2"> --}}
    {{-- <div class="row justify-content-between">  --}}
      {{-- <form action="{{route('item.search')}}" class="d-flex col-md-7 col-6 mx-2" role="search">
        <input name="searched" class="form-control input-custom me-2" type="search" placeholder="{{__('ui.searchbox')}}" aria-label="Search">
